...
PinnedRecentItem.prototype = {
  ...
  _init: function _init(menu, uri, pinIcon, title) {
...
SubSection.prototype = {
  ...
  _allocate: function _allocate(actor, box, flags) {
    ...
    var x = void 0;
    if (direction == St.TextDirection.LTR) x = box.x1;else x = box.x2;
    ...
    for (var i = 0, col = 0; i < this._children.length; i++) {
      var child = this._children[i];
